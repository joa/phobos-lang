// `iq1m_qdot_t`: see phobos-lang/src/codegen/tile/iq1m_qdot.rs.
...
#[test]
fn iq1m_qdot_t_has_no_per_lane_staging() {
...
#[test]
fn iq1m_qdot_t_reads_a_dynamic_contraction_length_at_runtime() {
    let mlir = emit_mlir(SRC);
    assert!(
