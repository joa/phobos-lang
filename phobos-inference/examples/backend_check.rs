...
//
//   cargo run --release -p phobos-inference --features cuda --example backend_check
//
...
use anyhow::Result;
use phobos_gguf::compute::{Attn, Backend, Buf, DeltaMix, HostBackend, Plane, Rope, read_vec};
